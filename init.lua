...
-- exec python3 with commandv
vim.keymap.set('n', '<C-E>', '<Cmd> !python3 %<CR>')
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'html', 'css', 'php', 'c', 'lua', 'vim', 'vimdoc', 'query', 'python', 'javascript' },
        auto_install = false,
